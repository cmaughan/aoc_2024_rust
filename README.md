...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `51.1µs` | `69.4µs` |
| [Day 2](./src/bin/02.rs) | `61.7µs` | `134.0µs` |
| [Day 3](./src/bin/03.rs) | `22.8µs` | `23.0µs` |
| [Day 4](./src/bin/04.rs) | `218.4µs` | `121.5µs` |
| [Day 5](./src/bin/05.rs) | `333.9µs` | `3.0ms` |
